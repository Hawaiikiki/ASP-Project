...
VALUES (N'20220720192505_InitialMigration', N'6.0.7');
GO
...
ALTER TABLE [Movies] ADD [CreatedBy] nvarchar(max) NOT NULL DEFAULT N'';
GO

ALTER TABLE [Movies] ADD [CreatedDate] datetime2 NULL;
GO

ALTER TABLE [Movies] ADD [ImdbUrl] nvarchar(max) NOT NULL DEFAULT N'';
GO

ALTER TABLE [Movies] ADD [OriginalLanguage] nvarchar(max) NOT NULL DEFAULT N'';
GO

ALTER TABLE [Movies] ADD [Price] decimal(18,2) NULL;
GO

ALTER TABLE [Movies] ADD [Rating] decimal(18,2) NULL;
GO

ALTER TABLE [Movies] ADD [ReleaseDate] datetime2 NULL;
GO

ALTER TABLE [Movies] ADD [RunTime] int NULL;
GO

ALTER TABLE [Movies] ADD [Tagline] nvarchar(max) NOT NULL DEFAULT N'';
GO

ALTER TABLE [Movies] ADD [TmdbUrl] nvarchar(max) NOT NULL DEFAULT N'';
GO

ALTER TABLE [Movies] ADD [UpdatedBy] nvarchar(max) NOT NULL DEFAULT N'';
GO

ALTER TABLE [Movies] ADD [UpdatedDate] datetime2 NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220720193415_movieTableUpdate', N'6.0.7');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220721181051_MovieTableUpdate2', N'6.0.7');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220721181935_CreatingTrailerTableWithMovieFK', N'6.0.7');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220721185316_CreatingMovieGenresJunctionTable', N'6.0.7');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20220726081151_CreatingRestOfTheTables', N'6.0.7');
GO
